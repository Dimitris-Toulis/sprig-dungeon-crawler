...
................
................`
const invisiblePlayerBitmap = bitmap`
................
................
..111111111111..
..122222222221..
...
function selectOrb(orb){
  ...
  if(collectedOrbs[prevOrb] == 7 || collectedOrbs[prevOrb] == 5){
    setLegend([ player, playerBitmap ],...sprites)
  }
  if(collectedOrbs[orb] == 7){
    setLegend([ player, transformedPlayerBitmap ],...sprites)
  }
  if(collectedOrbs[orb] == 5){
    setLegend([ player, invisiblePlayerBitmap ],...sprites)
  }
}
